  ...
  return knex('author').del()
    .then(function () {
      ...
      knex('author').insert({
       ...
       first_name: 'Steven',
       last_name:'Holden',
       bio:"Steve Holden Is a consultant, advising clients on system and network architectures and the design and implementation of programmed web systems. He also teaches classes on TCP/IP, network security, database and programming topics, and is the author of Python Web Programming, the OReilly School of Technology's Certificate series in Python and OReilly Media's Intermediate Python video series",
